...
public class OrderServiceTests {
	...
	void testUpdateOrder() {
		...
		int id = 1;
		List<Pizza> pizzas = Arrays.asList(new Pizza("Margarita", null, 10, 10, null));
		List<Pizza> newPizzas = Arrays.asList(new Pizza("Margarita", null, 10, 10, null),
				new Pizza("Kapri", null, 10, 10, null));
		Order order = new Order(1, pizzas, 20.0);
	...
	void testSaveOrderWithIdThatAlreadyExist() {
		// Arrange
		int id = 1;
		List<Pizza> pizzaList = Arrays.asList(new Pizza(1, "Margarita", null, 10.0, 10, null, null),
